...
Did not know that the == $0 that appears when you select an element in DevTools
can be used to reference to the element in console.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=felipeantunes542%40gmail.com).
