...
Learned that declarative programming means a paradigm where you're most
concerned on WHAT you want the program to do, whereas the imperative approach is
more concerned on HOW you're going to do the task.

Interesting that you need to pass an unique key to each element in the array
even when the array is not generated like in a map.

I have never noticed that the method `React.createElement` has the same name as
`document.createElement`.

The main role of React is to create elements and the main role of ReactDOM is to
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=felipeantunes542%40gmail.com).
